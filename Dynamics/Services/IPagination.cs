...
public interface IPagination
{
     ...
     */
    List<T> Paginate<T>(List<T> query, HttpContext context, PaginationRequestDto? paginationRequestDto = null, SearchRequestDto? searchRequestDto = null) where T : class;
